...
Unfortunately, after revising figure 1, we don't think it would be as straightforward to implement (some of the smaller points are woven into the same sections as the bigger ones, e.g., we talk about conflicts of interest and positionality statements together). 
