...
While our coverage of these areas cannot be exhaustive, we highlight eight open science practices within these areas: positionality statements and declarations of conflict of interest, open materials^[The idea of open materials can be viewed as both a stance (i.e., one's willingness to make materials available), and part of the workflow/dissemination process (i.e., how one goes about making materials open and accessible). We touch on this idea in each of the following sections.], reproducible code/projects and literate programming, preregistration, registered reports, and pre-prints. 
...
In addition, the reader is referred to the project, data, and variable level documentation of the present project, all of which are freely available on the OSF: <https://osf.io/bsu2q/?view_only=68d1e41b327f4a28a9fcd0fc6537ecaf>.
...
The present manuscript was generated using literate programming via Quarto and is available for download on the Open Science Framework: <https://osf.io/bsu2q/?view_only=68d1e41b327f4a28a9fcd0fc6537ecaf>. 
...
Additionally, the project files of the present work, including data, code, and markdown files, are publicly available on the OSF: <https://osf.io/bsu2q/?view_only=68d1e41b327f4a28a9fcd0fc6537ecaf>. 
...
#| fig-cap: "Preprints on the Open Science Framework. The left panel plots preprints as a function of year. The right panel plots cumulative preprints since 2016. Data scraped from <https://osf.io/search> on 12-15-2024."
...
We have provided descriptions and relevant examples of these practices to accompany the many guides already available for learning open science [e.g., @cruwell20187; @lewis2020open, <https://FOSIL-project.github.io>, among many others]. 
...
contributions <- list(
  ...
  "002" = tibble(role = c(1, 13, 14), weight = "low"),         # GCD
  "003" = tibble(                                              # IRA
      role = c(1, 2, 7, 13, 14), 
  ...
  "006" = tibble(role = 13, weight = "low"),                   # AG
  "007" = tibble(role = 13, weight = "low"),                   # AM
  "008" = tibble(role = 13, weight = "low"),                   # KL
  "009" = tibble(role = 13, weight = "low"),                   # JT
  "010" = tibble(role = 13, weight = "low"),                   # RTG
  "011" = tibble(role = 13, weight = "low"),                   # KT
  "012" = tibble(role = 13, weight = "low"),                   # IC
  "013" = tibble(role = c(1, 13, 14), weight = "low"),         # NR
  "014" = tibble(role = c(1, 7, 13, 14), weight = "low"),      # KP
  "015" = tibble(role = 14, weight = "high"),                  # MFR
  "016" = tibble(role = c(1, 14), weight = c("low", "high"))   # RE
  )
