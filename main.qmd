...
author            : 
  ...
  - name: Nicole Rodríguez
    affiliations: Rutgers University
    email: nmrodriguez1994@gmail.com
...
<!-- I had to read this sentence twice to get it, I think its the "at the same time that they are expected part that got me. Maybe just breaking it into two sentences? --> 
...
<!-- is direction to or is directed to? -->
...
<!-- okay hear me out, what if you combine the above two paragraphs and delete lines 210-214 and add something like, "In this section we detail how to make data open and accessible while also listing its benefits." or something like that --> 
...
<!-- not a fan of "gone are the days of" can we just start with "Many journals..." --> 
Firstly, data storage is a critical aspect that researchers must prioritize, focusing on its longevity and accessibility. 
<!-- the firstly here is throwing me off, what's this first about? Maybe something like "To make data open and available, data storage is a critical aspect that researchers must prioritize." -->
...
<!-- are we assuming that people who don't know anything about open science know what a project page is? also maybe just delete this sentence--> 
...
<!-- if we delete line 232, we could change 234 to "Data storage options include various cloud-based blah blah blah.." --> 
...
Open data in linguistics offers significant benefits. 
...
<!-- is our only arguement here that it enhances the study of minority languages/communities? what about researchers that don't study that? shouldn't add something that talks more about reproducibility as a whole? or the argument in the first paragraph was about enhancing collaboration and improving access to knowledge -->
...
<!-- is line 259 necessarily true? making someone's speech data available is still a privacy issue, but also isn't this a general concern with any data collection in any research study? -->
...
Innovations in this domain, facilitated by platforms like the OSF and tools such as Git, have revolutionized data sharing in the academic sphere. 
...
<!-- i don't think we mentioned "demystifies complex academic concepts for the general public at all in the above paragraphs should should probably delete unless we want to add about it -->
...
<!-- there was a huge emphasis on minoritized languages/communities above and then its not here? idk it seems weird to double down on it above and not add it here -->
...
<!-- should i make a Tom comment and say "This what?????" (i already fixed it on line 302, but line 298 doesn't bother me as much) -->

In order to ensure reproducibility, it is necessary to be transparent about the methods used in research. 
This transparency includes not only the data collection and analysis methods but also the code used to conduct the analysis. 
In the fields of psychology and linguistics, there is an increasing awareness of the importance of reproducibility, and many researchers are taking steps to improve the transparency of their research.
...
<!-- i dont understand the difference between 305-308 and 310-312 --> 
...
<!-- do those platforms or dependency tools need to be cited? -->
...
<!-- 327 is exactly the same as line 303 -->
...
In this scenario, the researcher might concentrate on distinct acoustic markers linked with stress, like pitch, duration, and/or intensity. <!-- so true, bestie -->
...
<!-- with researchers encouraged or where researchers are encouraged to? --> 
...
<!-- we already appreviated OSF before so it should change to that, right? or is this now different because the F isn't capitalized here -->
...
<!-- maybe add a few journals that currently accept them or require them? -->
...
<!-- at this point in the paper i think these opening sentences are a little late/redundant.. -->
...
<!-- "reader audience" sounds funny for me (maybe bc its 10:30pm) -->
...
<!-- maybe add a sentence at the beginning like "The process of pre-printing is simple." or "Here is an outline of the process of pre-pre-printing." -->
