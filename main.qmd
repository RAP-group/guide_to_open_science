...
contributoR::contributor(
  contributions = list(
  "001" = tibble::tibble(role = 1:14, weight = "high"),
  "002" = tibble::tibble(role = 1:3, weight = "low"),
  "003" = tibble::tibble(role = 1:3, weight = "low"),
  "004" = tibble::tibble(role = 1:3, weight = "low"),
  "005" = tibble::tibble(role = 1:3, weight = "low"),
  "006" = tibble::tibble(role = 1:3, weight = "low"),
  "007" = tibble::tibble(role = 1:3, weight = "low"),
  "008" = tibble::tibble(role = 1:3, weight = "low"),
  "009" = tibble::tibble(role = 1:3, weight = "low"),
  "010" = tibble::tibble(role = 1:3, weight = "low"),
  "011" = tibble::tibble(role = 1:3, weight = "low"),
  "012" = tibble::tibble(role = 1:3, weight = "low"),
  "013" = tibble::tibble(role = 1:3, weight = "low"),
  "014" = tibble::tibble(role = 1:3, weight = "low"), 
  "015" = tibble::tibble(role = 1:3, weight = "low"), 
  "016" = tibble::tibble(role = 1:3, weight = "low")
  ), 
  weight = TRUE
)
```
